...
export default async function Actor({params}:{params:Promise<idi>}){
    ...
    const moviefetch=await fetch("https://letter-box-steel.vercel.app/actors/"+ aid.id)
    const actorfetch=await fetch("https://letter-box-steel.vercel.app/actorsdets/"+ aid.id)
