...
export default function Profile(props:any){
    ...
    var fav=user[props.id].favorites
    var reviews=user[props.id].reviews
    console.log(reviews)
    return(
        <>  
            ...
            <p id={styles.favHeading}>Favorites</p>
                <ul id={styles.favMovies}>
                    {fav.map(movie=><li><Image className={styles.MoviePoster} src={movies[movie].poster} alt="Movie" width={170} height={250 }/></li>)}
                </ul>
            </div>
            ...
            <div id={styles.reviews}>
                ...
                <div className={styles.movieCard}>
                    {reviews.map(review=><Image className={styles.revMoviePoster} alt="Movie Poster" width={170} height={250} src={movies[review.id].poster}/>)}
                </div>
            </div>
        </>
    )
